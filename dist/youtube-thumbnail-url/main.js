...
var AppComponent = /** @class */ (function () {
    function AppComponent() {
        this.title = 'Youtube Thumbnails URL';
    ...
    AppComponent.prototype.getThumbnailUrls = function () {
        this.listOfThumbnails = [];
        var isValid = this.validateYoutubeURL(this.videoURL);
        if (!isValid)
    ...
    AppComponent.prototype.validateYoutubeURL = function (url) {
...
module.exports = __webpack_require__(/*! D:\shilpa\Angular-workspace\app-youtube-thumbnail-url\youtube-thumbnail-url\src\main.ts */"./src/main.ts");
